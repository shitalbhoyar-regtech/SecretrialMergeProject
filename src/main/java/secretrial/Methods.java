...
import CompnaySecretory.EntityLocator;
...
//	    EntityLocator.selectMaster(driver).click();
	    ...
	    if(EntityLocator.clickEntity(driver).isEnabled())
	    {
	      ...
	      test.log(LogStatus.PASS, "User should be redirected to the entity page");
	    }
	    else
	    {
	    	 test.log(LogStatus.FAIL, "User should not be redirected to the entity page");
	    }
...
//	    EntityLocator.selectMaster(driver).click();
		...
		selectOptionFromDropDown_bs(entitytype, "Private Limited Company");
	...
	public static void EnterInvalidDataPrivateLtd(WebDriver driver, ExtentTest test) throws InterruptedException
	{
...
//			  String msg7=EntityLocator.InValidCity(driver).getText();
	...
	public static void CloseBtnPrivateLtd(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		Thread.sleep(2000);
		EntityLocator.selectImg(driver).click();
//	    Thread.sleep(2000);
//	    EntityLocator.selectMaster(driver).click();
	...
	public static void EditIconPrivateLtd(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	{
	    ...
	    EntityLocator.clickEntity(driver).click();
	    Thread.sleep(2000);
	    EntityLocator.ClickFilter(driver).sendKeys("U72266KA2002PLC038433",Keys.ENTER);
	    Thread.sleep(2000);
	...
	public static void InvalidEditIconPrivateLtd(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	{
		Thread.sleep(2000);
		EntityLocator.selectImg(driver).click();
		Thread.sleep(2000);
    ...
    EntityLocator.clickEntity(driver).click();
    Thread.sleep(2000);
    EntityLocator.ClickFilter(driver).sendKeys("U15316MH2014PTC257960",Keys.ENTER);
    Thread.sleep(2000);
    EntityLocator.clickEditIcon1(driver).click();
	Thread.sleep(2000);
	...
	public static void DocumentsADDExisting(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		{
			test.log(LogStatus.FAIL,"To check whether user is able to add existing data or not. (For Type AOA):-  " + msg1);
		}
		Thread.sleep(3000);
		Locator.Close(driver).click();
		Thread.sleep(1000);
	...
	public static void ViewAOA(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    {
	    	test.log(LogStatus.FAIL,  " document Type AOA :- View  successfully.");
	    }
		Locator.Viewclose(driver).click();
		Thread.sleep(3000);
	...
	public static void ViewCOI(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	   ...
	   {
		   test.log(LogStatus.FAIL,  " document Type AOA :- Document does not View  successfully.");
	   }
		Locator.Viewclose(driver).click();
		Thread.sleep(3000);
	...
	public static void ViewLicenseRegi(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		{
			test.log(LogStatus.FAIL,  " document Type LICENSE_REGISTRATION :- View  successfully.");
		}
		Thread.sleep(2000);
		Locator.Viewclose(driver).click();
		Thread.sleep(3000);
	...
	public static void BankDetailsClick(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    EntityLocator.ClickFilter(driver).sendKeys("U15316MH2014PTC257960",Keys.ENTER);
	    Thread.sleep(2000);
		 EntityLocator.clickEditIcon1(driver).click();	Thread.sleep(3000);
		Thread.sleep(2000);
	...
	public static void BankDetailAddnew(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		Thread.sleep(1000);
		Locator.OpeningDate(driver).click();
		Thread.sleep(1000);
...
Locator.ClickDashboard(driver).click();
	...
	//	Locator.EditBD(driver).click();
		Thread.sleep(3000);
		By locator = By.xpath("//*[@id='gridbank']/table/tbody/tr[1]/td[9]/a[1]");
	...
	public static void BankDetailDeleteCan(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		{
			test.log(LogStatus.FAIL,  "user deletes an item and cancels deletion Successfully");
		}
		Thread.sleep(1000);
		 Locator.ClosePopEntity(driver).click();
		 Thread.sleep(1000);
	...
	public static void PublicLimitedEdit(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
	    ...
	    EntityLocator.clickEntity(driver).click();
	    Thread.sleep(2000);
	    EntityLocator.ClickFilter(driver).sendKeys("U72200KA2002PLC030311",Keys.ENTER);
	    Thread.sleep(2000);
	    EntityLocator.clickEditIcon1(driver).click();
	    Thread.sleep(2000);
	    EntityLocator.clickEntityType(driver).click();
...
//	    EntityLocator.selectMaster(driver).click();
	...
	test.log(LogStatus.PASS,"Message Display ; - "+ msg1+", "+msg3+", "+msg4);
	Locator.SaveE(driver).click();
	Thread.sleep(3000);
	Thread.sleep(4000);
	Locator.CloseEntity(driver).click();
	...
	public static void EntityMoreOption(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		List<WebElement>roc = driver.findElements(By.xpath("//*[@id='griDDLActionMenu_listbox']/li"));
		selectOptionFromDropDown_bs(roc, "Related Companies");
	...
	public static void EntityMoreOption1(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    EntityLocator.clickEntity(driver).click();
	    Thread.sleep(2000);                                                                          
	    EntityLocator.ClickFilter(driver).sendKeys("U72200KA2002PLC040311",Keys.ENTER); 
		Thread.sleep(3000);
		...
		List<WebElement>roc = driver.findElements(By.xpath("//*[@id='griDDLActionMenu_listbox']/li"));
		selectOptionFromDropDown_bs(roc, "Capital");
	...
	public static void RCSharesHeld(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		Locator.SharesHeld(driver).click();
		Thread.sleep(2000);
		Locator.SharesHeldText(driver).sendKeys("50%");
		Thread.sleep(2000);
		Locator.SaveRC(driver).click();
		Thread.sleep(3000);
	...
	public static void RCSearchField(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		selectOptionFromDropDown_bs(roc, "Related Companies");
		Thread.sleep(4000);
		Locator.search(driver).sendKeys("L67120MP1994PLC008656",Keys.ENTER);
		Thread.sleep(2000);
		String text=Locator.searchText(driver).getText();
		Thread.sleep(2000);
		if(text.equalsIgnoreCase("L67120MP1994PLC008656")) {
	...
	public static void  Shareholding(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		Thread.sleep(4000);
		List<WebElement>roc = driver.findElements(By.xpath("//*[@id='griDDLActionMenu_listbox']/li"));
		selectOptionFromDropDown_bs(roc, "Shareholding");
		Thread.sleep(3000);
	...
	public static void PLViewPolicy(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		wait.until(ExpectedConditions.elementToBeClickable(Locator.ViewPolicy(driver)));
		Thread.sleep(5000);
		Locator.ViewPolicy(driver).click();
		Thread.sleep(2000);
		String	msg1=Locator.ViewMsg(driver).getText();
	...
	public static void PLDocumentsADDAnnualReport(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		By locator1 = By.xpath("(//button[@id='saveppcom'])[2]");
...
Locator.ClickDashboard(driver).click();
	...
	//	Locator.EditBD(driver).click();
		Thread.sleep(3000);
		By locator = By.xpath("//tbody/tr[2]/td[9]/a[1]");
...
//	    EntityLocator.selectMaster(driver).click();
		...
		Thread.sleep(4000);
		Locator.RTAWebSite(driver).sendKeys("www.google.com");
		
		Thread.sleep(4000);
		Locator.ISINCode(driver).sendKeys("INE0J1Y01017");
		...
		Thread.sleep(3000);
		Locator.clickEquityStakExchange(driver).click();
		
		Thread.sleep(3000);
		Locator.clickEquityStakExchangeNew(driver).click();
		...
		Thread.sleep(3000);
		Locator.clickScripCode(driver).sendKeys("234567");
		
		Thread.sleep(3000);
		Locator.clickScripSymbol(driver).sendKeys("^[A-Za-z]+$");
		
		Thread.sleep(3000);
		Locator.clickStockExchangeUpdate(driver).click();
...
//	    EntityLocator.selectMaster(driver).click();
		...
		Thread.sleep(4000);
		Locator.RTAWebSite(driver).sendKeys("fgt");
		
		Thread.sleep(4000);
		Locator.ISINCode(driver).sendKeys("453");
		...
		Thread.sleep(3000);
		Locator.clickScripCode(driver).sendKeys("45");
		...
		Locator.clickStockExchangeUpdate(driver).click();
				...
				String msg1=Locator.InvalidMsgeCIN(driver).getText();
				Thread.sleep(1000);
				String msg2=Locator.InvalidMsgePan(driver).getText();
				Thread.sleep(1000);
				String msg3=Locator.InvalidMsgeEmail(driver).getText();
				Thread.sleep(1000);
				String msg4=Locator.InvalidRTAWebSite(driver).getText();
				Thread.sleep(1000);
				String msg5=Locator.InvalidISINmsg(driver).getText();
				Thread.sleep(1000);
				String msg6=Locator.InvalidScriptCode(driver).getText();
				
				Thread.sleep(1000);
				test.log(LogStatus.PASS,"Message Display ; -"+ msg1+ ", "+ msg2+", "+ msg3+","+msg4+","+msg5+","+msg6+"");
				Locator.SaveE(driver).click();
				Thread.sleep(3000);
				Thread.sleep(4000);
				Locator.CloseEntity(driver).click();
...
//		String msg7=	Locator.InvalidMsgecity(driver).getText();
//		Thread.sleep(1000);
//		String msg8=Locator.InvalidRTAWebSite(driver).getText();
//		Thread.sleep(1000);
//		String msg9=Locator.InvalidISINmsg(driver).getText();
		//Thread.sleep(1000);
		//String msg10=Locator.InvalidScriptCode(driver).getText();
	...
	public static void  DebentureHolding(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		Thread.sleep(4000);
		List<WebElement>roc = driver.findElements(By.xpath("//*[@id='griDDLActionMenu_listbox']/li"));
		selectOptionFromDropDown_bs(roc, "Debenture Holding");
		Thread.sleep(3000);
	...
	public static void  DebentureHoldingSearch(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		selectOptionFromDropDown_bs(roc, "Debenture Holding");
			Thread.sleep(1000);
			Locator.SearchDH(driver).sendKeys("4567DH",Keys.ENTER);
			Thread.sleep(3000);
			String Text =Locator.FolioNoValue(driver).getText();
			if(Text.equalsIgnoreCase("4567DH")) {
	...
	public static void DHDAddNewEmpty(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		{
			Thread.sleep(2000);
			String Text =Locator.SavehdInvalidMsgDhd(driver).getText();
			Thread.sleep(1000);
	...
	public static void SecretarialAuditor(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    EntityLocator.clickEntity(driver).click();
	    Thread.sleep(2000);                                                                          
	    EntityLocator.ClickFilter(driver).sendKeys("U72200KA2002PLC040311",Keys.ENTER);  //Listed company
	    ...
	    Thread.sleep(4000);
		List<WebElement>roc = driver.findElements(By.xpath("//*[@id='griDDLActionMenu_listbox']/li"));
		selectOptionFromDropDown_bs(roc, "Auditors");
...
//				Locator.Certificate_of_Practice(driver).sendKeys(c1.getStringCellValue()); // Writing Task title
				...
				Thread.sleep(1000);	
				EntityLocator.NameOfPractice(driver).sendKeys("LNT");
				Thread.sleep(1000);	
				EntityLocator.MembershipType(driver).click();
				
				Thread.sleep(1000);	
				EntityLocator.SelectMembershipType(driver).click();
				Thread.sleep(1000);	
				EntityLocator.ACSFCSno(driver).sendKeys("4");
				
				Thread.sleep(1000);	
				EntityLocator.Place(driver).sendKeys("Mumbai");
	...
	public static void ResignationofAuditor(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		selectOptionFromDropDown_bs(roc, "Auditors");
			Thread.sleep(3000);
				...
				Locator.Reason(driver).sendKeys("abc"); // Writing Task title
				Thread.sleep(2000);
				
				Locator.ChooseFileRA(driver).sendKeys("C:\\Users\\snehalp\\Desktop\\sample.pdf"); // Writing Task title
				Thread.sleep(2000);
	...
	public static void ResignationofAuditorCA(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		selectOptionFromDropDown_bs(roc, "Auditors");
			Thread.sleep(3000);
				...
				String Text =Locator.SaveRA(driver).getText();
				Thread.sleep(1000);
				if(Text.equalsIgnoreCase("Saved Successfully.")) {
					test.log(LogStatus.PASS,Text );
	...
	public static void ResignationofAuditorEmptyCA(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
		...
		selectOptionFromDropDown_bs(roc, "Auditors");
			Thread.sleep(3000);
				...
				String Text =Locator.FileRA(driver).getText();
//				Thread.sleep(1000);
//				String Text1 =Locator.DatedVal(driver).getText();
				Thread.sleep(1000);
	...
	public static void StatutoryRegisters(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    Thread.sleep(4000);
		List<WebElement>roc = driver.findElements(By.xpath("//*[@id='griDDLActionMenu_listbox']/li"));
		selectOptionFromDropDown_bs(roc, "Statutory Registers");
//		Thread.sleep(3000);
	...
	public static void SRSH3AddNewInvalid(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		Locator.SRSH3AddNew(driver).click();
		Thread.sleep(3000);
		Locator.NoOfSwt_EqShare(driver).sendKeys("s");
		Thread.sleep(3000);
		Locator.FaceValOfShare(driver).sendKeys("s");
		Thread.sleep(3000);
		Locator.PriceAtShareIssued(driver).sendKeys("s");
		Thread.sleep(3000);
		Locator.AmtOfPaidUp(driver).sendKeys("s");
		Thread.sleep(3000);
		Locator.Considertaion_Cash(driver).sendKeys("s");
		Thread.sleep(2000);
		...
		String Text =driver.findElement(By.xpath("//*[@id='frmSH3Register']/div[3]/div[2]/span")).getText();
		String Text1 =driver.findElement(By.xpath("//*[@id='frmSH3Register']/div[3]/div[4]/span")).getText();
		String Text2 =driver.findElement(By.xpath("//*[@id='frmSH3Register']/div[3]/div[5]/span")).getText();
		String Text3 =driver.findElement(By.xpath("//*[@id='frmSH3Register']/div[3]/div[6]/span")).getText();
		String Text4 =driver.findElement(By.xpath("//*[@id='frmSH3Register']/div[5]/div[2]/span")).getText();
		Thread.sleep(2000);
		test.log(LogStatus.PASS,"Message displayed:-"+Text+" ,"+Text1+" ,"+Text2+" ,"+Text3+" ,"+Text4);
	...
	public static void SRSH3UploadInValidEx(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		selectOptionFromDropDown_bs(roc, "Statutory Registers");
			...
			WebElement ViewButton = driver.findElement(locator);	
			Thread.sleep(3000);
			ViewButton.sendKeys("C:\\Users\\snehalp\\Desktop\\performer code.txt");		
//			Thread.sleep(3000);
//			Locator.UploadRD(driver).click();		
			Thread.sleep(2000);
	...
	public static void SRSH3EditInvalid(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		Locator.EditSH3(driver).click();	
		Thread.sleep(3000);
		Locator.NoOfSwt_EqShare(driver).clear();
		Thread.sleep(3000);
		Locator.NoOfSwt_EqShare(driver).sendKeys("s");
		Thread.sleep(3000);
		Locator.FaceValOfShare(driver).clear();
		Thread.sleep(3000);
		Locator.FaceValOfShare(driver).sendKeys("s");
		Thread.sleep(3000);
		Locator.PriceAtShareIssued(driver).clear();
		Thread.sleep(3000);
		Locator.PriceAtShareIssued(driver).sendKeys("s");
		Thread.sleep(3000);
		Locator.AmtOfPaidUp(driver).clear();
		Thread.sleep(3000);
		Locator.AmtOfPaidUp(driver).sendKeys("s");
		Thread.sleep(3000);
		Locator.Considertaion_Cash(driver).clear();
		Thread.sleep(3000);
		Locator.Considertaion_Cash(driver).sendKeys("s");
		Thread.sleep(2000);
...
jse.executeScript("arguments[0].click();", ViewButton);
	...
	WebElement ViewButton = driver.findElement(locator);	
	Thread.sleep(3000);
	ViewButton.sendKeys("D:\\Secretarial-Project-26JULY23\\Secretarial-Project-26JULY23\\Secretarial-Project-26JULY23\\Report\\Secretrial.html");	
	...
	String Msg=driver.switchTo().alert().getText();
	Thread.sleep(1000);
	test.log(LogStatus.PASS,  "Upload Invalid File :- " +Msg);
	driver.switchTo().alert().accept();
	...
	public static void SRCHG7ViewDoc(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		else
		{
			Locator.Document(driver).click();
			Thread.sleep(4000);
			test.log(LogStatus.PASS,  " The user should not redirected to the 'Document' page");
		}
...
//					String Text =Locator.Name__validationMessage(driver).getText();
					Thread.sleep(2000);
					String Text1 =Locator.ValidationMsgMBP2(driver).getText();
...
jse.executeScript("arguments[0].click();", ViewButton);
	...
	Thread.sleep(4000);
		...
		Thread.sleep(4000);
					...
					String Text =Locator.ValidationMsgMBP2(driver).getText();
					//Thread.sleep(2000);
					//String Text1 =Locator.CurrencyId_validationMessage(driver).getText();
					Thread.sleep(3000);
					if(Text.equalsIgnoreCase(Text))
	...
	// 	String Text2 =Locator.NatureOfTransactionId_validationMessage(driver).getText();
	            Thread.sleep(200);
             	String Text3 =Locator.ValidationMsgMBP2(driver).getText();
              	Thread.sleep(3000);
...
//					Thread.sleep(3000);
              	...
              	if(Text3.equalsIgnoreCase(Text3))
              	{
						test.log(LogStatus.PASS,  " Message displayed :" + Text3);
              	}
              	else
              	{
              		test.log(LogStatus.FAIL,  " Message displayed :" + Text3);
              	}
						Thread.sleep(2000);
	...
	public static void SRMB2UploadInvalid(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		Locator.UploadMB2(driver).click();		
		Thread.sleep(200);
		String Text =driver.findElement(By.xpath("//*[@id='frmUploadMBP2Excel']/div[1]/div/div/ul/li")).getText();
		String Text1 =driver.findElement(By.xpath("//*[@id='frmUploadMBP2Excel']/div[1]/div/div/ul/li[2]")).getText();
		String Text2 =driver.findElement(By.xpath("//*[@id='frmUploadMBP2Excel']/div[1]/div/div/ul/li[3]")).getText();
		String Text3 =driver.findElement(By.xpath("//*[@id='frmUploadMBP2Excel']/div[1]/div/div/ul/li[3]")).getText();
		Thread.sleep(2000);
		if(Text.equalsIgnoreCase(Text)) 
		{
			test.log(LogStatus.PASS,  " Message displayed : -"+Text +" , "+Text1 +","+Text2 +","+Text3);
			}
		else {
			test.log(LogStatus.FAIL,  " Message displayed : -"+Text +" , "+Text1 +","+Text2 +","+Text3);
			}
	...
	public static void SRMB2UploadInvalidformat(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		WebElement ViewButton = driver.findElement(locator);	
		Thread.sleep(3000);
		ViewButton.sendKeys("D:\\Secretarial-Project-26JULY23\\Secretarial-Project-26JULY23\\Secretarial-Project-26JULY23\\TestData\\1. Spresso MGT 7.pdf");
		Thread.sleep(1000);
		String Msg=driver.switchTo().alert().getText();
		Thread.sleep(1000);
		test.log(LogStatus.PASS,  "Upload Invalid File Format :- " +Msg);
		driver.switchTo().alert().accept();
	...
	public static void SRMB2UploadActionTab(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		WebElement ViewButton = driver.findElement(locator);	
		Thread.sleep(3000);
		ViewButton.sendKeys("D:\\Secretarial-Project-26JULY23\\Secretarial-Project-26JULY23\\Secretarial-Project-26JULY23\\TestData\\Scretrial.xlsx");		
		Thread.sleep(3000);
	...
	public static void SRMB3UploadInvalid(WebDriver driver, ExtentTest test,XSSFWorkbook workbook) throws InterruptedException
	 {
		...
		Locator.UploadRD(driver).click();		
		Thread.sleep(3000);
		String Text =Locator.UploadInvalidMsgMB3(driver).getText();
		Thread.sleep(2000);
		if(Text.equalsIgnoreCase(Text)) {
			test.log(LogStatus.PASS,  " Message displayed : -"+Text);
		}else {
