...
//	    EntityLocator.selectMaster(driver).click();
	    ...
	    Thread.sleep(8000);
By locator1 = By.xpath("(//button[normalize-space()='Close'])[1]");
WebDriverWait wait = new WebDriverWait( driver, (120));
	...
	jse1.executeScript("arguments[0].click();", ViewButton1);
		Thread.sleep(5000);
	 //    EntityLocator.CloseEntity1(driver).click();
...
//	    EntityLocator.selectMaster(driver).click();
	  ...
	  selectOptionFromDropDown_bs(comCat, "Company limited by shares");
	   ...
	   selectOptionFromDropDown_bs(finYr, "1 Apr - 31 Mar");
	    ...
	    Thread.sleep(2000);
	   // EntityLocator.LogoUpload(driver).sendKeys("C:\\Users\\mayurig\\Downloads\\02.04.2025_11.23.33_REC.png");
	 ...
	 Thread.sleep(3000);
	 By locator1 = By.xpath("//*[@id='saveppcom']");
	  WebDriverWait wait = new WebDriverWait( driver, (120));
	  ...
	  By locator2 = By.xpath("(//button[normalize-space()='Close'])[1]");
...
//	    EntityLocator.selectMaster(driver).click();
	    ...
	    Thread.sleep(2000);
			...
			String msg4=EntityLocator.InValidEmail(driver).getText();
			 ...
			 test.log(LogStatus.PASS, "Enter Invalid Fileds = " +msg1 +"," +msg3 +"," +msg4);
...
//			  String msg5=EntityLocator.InValidAddress(driver).getText();
		...
		//	  String msg7=EntityLocator.InValidCity(driver).getText();
				  	...
				  	test.log(LogStatus.PASS, "Enter Two Mandatory Fileds = " +msg);
...
//	    EntityLocator.selectMaster(driver).click();
		...
		selectOptionFromDropDown_bs(entitytype, "Deemed Public Company");
		  ...
		  Thread.sleep(2000);
	     if(EntityLocator.CloseEntity1(driver).isEnabled())
		    {
	    	 WebDriverWait wait = new WebDriverWait( driver, (120));
			  By locator2 = By.xpath("(//button[normalize-space()='Close'])[1]");
				wait.until(ExpectedConditions.presenceOfElementLocated(locator2));
...
//	     EntityLocator.ClickDashboard(driver).click();
	...
	public static void EditBAInvalidData(WebDriver driver,ExtentTest test) throws InterruptedException
	{
	   ...
	   // Thread.sleep(800);
		wait.until(ExpectedConditions.visibilityOf(EntityLocator.GridLoad(driver)));	//Wait until records table gets visible.
...
//	     EntityLocator.ClickDashboard(driver).click();
	...
	public static void AddNewDocument(WebDriver driver,ExtentTest test) throws InterruptedException
	{
	    ...
	    Thread.sleep(2000);
	    EntityLocator.ClickFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareHolding_BasicDetails.xlsx");
...
//	     EntityLocator.ClickDashboard(driver).click();
	...
	public static void AlreadyExistDocument(WebDriver driver,ExtentTest test) throws InterruptedException
	{
	    ...
	    Thread.sleep(2000);
	    EntityLocator.ClickFile(driver).sendKeys("D:\\Secretarial-Project-26JULY23\\Secretarial-Project-26JULY23\\Secretarial-Project-26JULY23\\Report\\Secretrial.html");
...
//		     EntityLocator.ClickDashboard(driver).click();
	...
	public static void AddExistingLicenseRegistration(WebDriver driver,ExtentTest test) throws InterruptedException 
	{
	    ...
	    Thread.sleep(2000);
	    EntityLocator.ClickFile(driver).sendKeys("D:\\Secretarial-Project-26JULY23\\Secretarial-Project-26JULY23\\Secretarial-Project-26JULY23\\TestData\\ComplianceSheet-11.xlsx");
...
//	     EntityLocator.ClickDashboard(driver).click();
	...
	public static void AddBranchDetailes(WebDriver driver,ExtentTest test,XSSFWorkbook workbook) throws InterruptedException 
	{
	  ...
	  //  wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("IframeMyCompliances"));
		...
		org.apache.poi.ss.usermodel.Cell c = row.getCell(1);						//Selected cell (1 row,1 column)
		String name = c.getStringCellValue();			//Got the URL stored at position 1,1
		EntityLocator.ClickName(driver).sendKeys("Satara1");
...
//		 EntityLocator.ClickContactNumber(driver).sendKeys(" "+ContactNumber);
		 ...
		 Thread.sleep(2000);
		 EntityLocator.SearchState(driver).sendKeys("Maharashtra");
		 Thread.sleep(2000);
		 List<WebElement>roc = driver.findElements(By.xpath("//*[@id='branch_stateId_listbox']/li"));
			selectOptionFromDropDown_bs(roc, "Maharashtra");
...
By locator1 = By.cssSelector("#gridKendobranchdetils > div.k-grid-content.k-auto-scrollable > table > tbody > tr:nth-child(1) > td.k-command-cell > a.k-button.k-button-icontext.k-grid-Edit.k-gridEditIcon > i");
...
//		     EntityLocator.ClickDashboard(driver).click();
	...
	public static void UploadDocBranchDetailes(WebDriver driver,ExtentTest test,XSSFWorkbook workbook) throws InterruptedException 
	{
	    ...
	    Thread.sleep(2000);
	    EntityLocator.SelectFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\demo_.docx");
...
//	     EntityLocator.ClickDashboard(driver).click();
	...
	public static void InvalidUploadDocBranchDetailes(WebDriver driver,ExtentTest test,XSSFWorkbook workbook) throws InterruptedException 
	{
	    ...
	    Thread.sleep(2000);
	    EntityLocator.SelectFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ComplianceSheet-11.xlsx");
...
//	     EntityLocator.ClickDashboard(driver).click();
	...
	public static void InvalidMultipleFileUploadDocBranchDetailes(WebDriver driver,ExtentTest test,XSSFWorkbook workbook) throws InterruptedException 
	{
	    ...
	    Thread.sleep(2000);
	    EntityLocator.SelectFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareHolding_BasicDetails.xlsx");
	    Thread.sleep(2000);
	    EntityLocator.SelectFile(driver).sendKeys("D:\\Test Cases\\Sony test cases.xlsx");
...
//		EntityLocator.ClickAccNo(driver).sendKeys(""+AccNo);
	    Thread.sleep(2000);
	    EntityLocator.ClickAccNo(driver).sendKeys("65327523432");
...
//		EntityLocator.ClickAccNo(driver).sendKeys(""+AccNo);
	    Thread.sleep(2000);
	    EntityLocator.ClickAccNo(driver).sendKeys("65827523432");
...
//		EntityLocator.SelectAccType(driver).click();
	...
	public static void DeleteBankDetailes(WebDriver driver,ExtentTest test) throws InterruptedException 
	{
		...
		// EntityLocator.DeleteBankDetailes(driver).click();
		 ...
		 Thread.sleep(2000);
		 By locator1 = By.xpath("//*[@id='gridbank_active_cell']/a[2]/i");
...
//	  EntityLocator.ClickRoc(driver).click();
	  ...
	  Thread.sleep(2000);
	    Row row7 = sheet.getRow(41);						//Selected 1st index row (Second row)
		org.apache.poi.ss.usermodel.Cell c7 = row7.getCell(1);						//Selected cell (1 row,1 column)
		String address1 = c7.getStringCellValue();			//Got the URL stored at position 1,1
		EntityLocator.LLPAddressC(driver).sendKeys(address1);
		
		 Thread.sleep(2000);
		  EntityLocator.LLPStateC(driver).click();
		  Thread.sleep(2000);
		  List<WebElement>state1 = driver.findElements(By.xpath("//*[@id='ddlcorStatellp_listbox']/li"));
		  selectOptionFromDropDown_bs(state1, "Maharashtra");
		
		  Thread.sleep(2000);
		  EntityLocator.LLPCityC(driver).click();
		  Thread.sleep(3000);
		  List<WebElement>city1 = driver.findElements(By.xpath("//ul[@id='ddlllpcorCity_listbox']//li"));
		  selectOptionFromDropDown_bs(city1, "Ahmadnagar");
...
//	  EntityLocator.ClickRoc(driver).click();
	...
	public static void AddNewDocumentLLP(WebDriver driver,ExtentTest test) throws InterruptedException
	{
	    ...
	    Thread.sleep(2000);
	    EntityLocator.ClickFile(driver).sendKeys("D:\\Test Cases\\Sony test cases.xlsx");
...
By locator1 = By.cssSelector("#gridKendobranchdetils > div.k-grid-content.k-auto-scrollable > table > tbody > tr:nth-child(1) > td.k-command-cell > a.k-button.k-button-icontext.k-grid-Edit.k-gridEditIcon > i");
	...
	public static void InvalidUploadDocBranchDetailesLLP(WebDriver driver,ExtentTest test,XSSFWorkbook workbook) throws InterruptedException 
	{
	    ...
	    Thread.sleep(2000);
	    EntityLocator.SelectFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\LLP Sample File.xlsx");
...
//	    EntityLocator.clickEditIcon(driver).click();
	...
	public static void EntityExcelUploadFile(WebDriver driver,ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\EntityExcelFile.xlsx");
		Thread.sleep(2000);
	...
	public static void InvalidDataEntityExcelUploadFile(WebDriver driver,ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\EntityExcelFile1.xlsx");
		Thread.sleep(2000);
		EntityLocator.clickUploadButton1(driver).click();
	...
	public static void WithoutEnteringDataEntityExcelUploadFile(WebDriver driver,ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\EntityExcelFile2.xlsx");
		Thread.sleep(2000);
		EntityLocator.clickUploadButton1(driver).click();
	...
	public static void EnterInvalidEntityExcelUploadFile(WebDriver driver,ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareHolding_BasicDetails.xlsx");
		Thread.sleep(2000);
		EntityLocator.clickUploadButton1(driver).click();
		Thread.sleep(8000);
		try 
	...
	public static void LLPExcelUploadFile(WebDriver driver,ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\LLP Sample File.xlsx");
		Thread.sleep(2000);
		EntityLocator.clickUploadButton1(driver).click();
		Thread.sleep(2000);
		try 
	...
	public static void InvalidDataLLPExcelUploadFile(WebDriver driver,ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\LLP Sample File1.xlsx");
		Thread.sleep(2000);
		EntityLocator.clickUploadButton1(driver).click();
	...
	public static void WithoutEnteringDataLLPExcelUploadFile(WebDriver driver,ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\LLP Sample File2.xlsx");
		Thread.sleep(2000);
		EntityLocator.clickUploadButton1(driver).click();
	...
	public static void EnterInvalidLLPExcelUploadFile(WebDriver driver,ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\Scretrial.xlsx");
		Thread.sleep(2000);
		EntityLocator.clickUploadButton1(driver).click();
	...
	public static void MGT7ExcelUploadFile(WebDriver driver,ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\BFN_Form_MGT_7SPZSPZ_28 12 2021.pdf");
	...
	public static void MGT7ExcelDiffPDFInvalidUploadFile(WebDriver driver,ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\KAPL - MGT-7 (2020-21)-25.03.2022 Signed  T90729922.pdf");
		Thread.sleep(2000);
		EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\KAPL - MGT-7 (2020-21)-25.03.2022 Signed  T90729922.pdf");
		   ...
		   if(EntityLocator.ClickMoreActionApplicability(driver).isEnabled())
		    {
			   Thread.sleep(2000);
				...
				selectOptionFromDropDown_bs(entitytype, "Applicability");
...
//	      EntityLocator.ClickDeposit(driver).sendKeys("5");
	...
	public static void YesRadioBtnApplicability(WebDriver driver, ExtentTest test) throws InterruptedException
	{
	    ...
	    EntityLocator.clickEntity(driver).click();
	    Thread.sleep(2000);
	    EntityLocator.ClickFilter(driver).sendKeys("U72266KA2562PLC278030",Keys.ENTER);
...
//	      EntityLocator.ClickShareHolding(driver).click();
		  ...
		  Thread.sleep(2000);
		  EntityLocator. ClickModeOfShareHolding(driver).click();
		  
		  Thread.sleep(2000);
		  EntityLocator.selectModeOfShareHolding(driver).click();
...
//			  EntityLocator.ClickLockInPeriod(driver).sendKeys("13$A");
			  ...
			  Thread.sleep(2000);
			  EntityLocator.ClickAmountPayable(driver).click();
			  
			  Thread.sleep(2000);
			  EntityLocator.ClickDeemedtobepaid(driver).click();
			  
			  Thread.sleep(2000);
			  EntityLocator.ClickDueAmount(driver).click();
...
//			  EntityLocator.ClickDueAmount(driver).sendKeys("2000");
	...
	public static void UploadShareHolding(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      Thread.sleep(4000);
	      EntityLocator.ClickChooseFileShareHolding(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareHolding_BasicDetails.xlsx");
...
WebDriverWait wait=new WebDriverWait(driver,20);
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      Thread.sleep(4000);
	      EntityLocator.ClickChooseFileShareHolding(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareHolding_BasicDetails (1).xlsx");
	...
	public static void EmptyFileUploadShareHolding(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      Thread.sleep(4000);
	      EntityLocator.ClickChooseFileShareHolding(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareHolding_BasicDetails (2).xlsx");
...
WebDriverWait wait=new WebDriverWait(driver,20);
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      Thread.sleep(4000);
	      EntityLocator.ClickChooseFileShareHolding(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareholdingDetails (3).xlsx");
...
//	      EntityLocator.ClickNonPromoter(driver).click();
	...
	public static void UploadShareholdingCategoryMaster(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      Thread.sleep(2000);
	      EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareholdingCategory (4).xlsx");
	...
	public static void EnterInvalidDataUploadShareholdingCategoryMaster(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      Thread.sleep(2000);
	      EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareholdingCategory (3).xlsx");
...
//	      EntityLocator.ClickCloseCategoryMaster(driver).click();
	      ...
	      Thread.sleep(2000);
	      EntityLocator.ClickCloseBtnSHD(driver).click();
...
//	      EntityLocator.ClickCloseCategoryMaster(driver).click();
	...
	public static void EnterEmptyDataUploadShareholdingCategoryMaster(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      Thread.sleep(2000);
	      EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareholdingCategory (5).xlsx");
...
// 	 	  EntityLocator.ClickDashboard(driver).click();
	...
	public static void EnterInvalidDateShareHoldingHistorical(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      Thread.sleep(2000);
	      EntityLocator.ClickShareholdingHistoricalStartDate(driver).click();
	      
	      Thread.sleep(2000);
	      EntityLocator.ClickDateOfTransfer(driver).click();     		//ShareHoldingHistoricalDate
	      
	      Thread.sleep(2000);
	      EntityLocator.ClickShareholdingHistoricalEndDate(driver).click();
	    
	      Thread.sleep(2000);
	      EntityLocator.ClickDateOfTransfer1(driver).click();     		//ShareHoldingHistoricalDate
	...
	public static void ViewButtonShareHoldingHistorical(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      Thread.sleep(8000);
	      if(EntityLocator.ClickViewBtn(driver).isEnabled())
		    {
		      Thread.sleep(2000);
		    ...
		    {
		    	   test.log(LogStatus.PASS, "View icon not open Successfully");
		    }
	...
	public static void EditBtnShareHoldingDetailes(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      Thread.sleep(4000);
	      EntityLocator.ClickEditShareHoldingDetailes(driver).click();                //Edit ShareHolding button 
	      
	      Thread.sleep(2000);
		  EntityLocator.ClickShareHoldingDetailes(driver).click();
	      Thread.sleep(4000);
	      if(EntityLocator.ClickEditIconSH(driver).isEnabled())                       //Edit ShareHolding Detailes button
		    {
              Thread.sleep(4000);
...
//			  EntityLocator.ClickShareHoldingDetailes(driver).click();
	...
	public static void CloseBtnShareHolding(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(7000);
	      ...
	      Thread.sleep(4000);
	      if(EntityLocator.ClickCloseBtn(driver).isEnabled())
		    {
		      Thread.sleep(2000);By locator = By.xpath("/html/body/div[13]/div[1]/div/a");
	...
	public static void AddShareCertificate(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(7000);
	      ...
	      Thread.sleep(2000);
	      EntityLocator.ClickFilter1(driver).click();         //Save button
	...
	public static void WithoutEnteringDataShareCertificate(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		Thread.sleep(7000);
	     ...
	     /* Thread.sleep(7000);
	      String msg1=EntityLocator.InValidMsgShareCertificate(driver).getText();
	      Thread.sleep(7000);
	      String msg2= EntityLocator.InValidMsgShareCertificate1(driver).getText();
	      Thread.sleep(7000);
	      String msg3=EntityLocator.InValidMsgShareCertificate2(driver).getText();
	      Thread.sleep(7000);
	      String msg4= EntityLocator.InValidMsgShareCertificate3(driver).getText();
	      Thread.sleep(7000);
	      String msg5=EntityLocator.InValidMsgShareCertificate4(driver).getText();
	      Thread.sleep(7000);
	      String msg6=EntityLocator.InValidMsgShareCertificate5(driver).getText();
	      
	      
	      Thread.sleep(7000);
	      test.log(LogStatus.PASS, "Message Displayed ="  +msg1 +"," +msg2 +"," +msg3 +"," +msg4  +"," +msg5 +"," +msg6);
	   */
	      Thread.sleep(2000);
	      String msg=EntityLocator.ValidMsgShareCertificate(driver).getText();
	...
	public static void ViewShareCertificate(WebDriver driver, ExtentTest test) throws InterruptedException
	{
		...
		selectOptionFromDropDown_bs(entitytype, "Shareholding");
	      ...
	      EntityLocator.ClickShareCertificateBtn(driver).click();
	      Thread.sleep(7000);
	      if(EntityLocator. ViewShareCertificate(driver).isEnabled())
	      {  
	    	  Thread.sleep(2000);
	    	  EntityLocator. ViewShareCertificate(driver).click();
	    	  test.log(LogStatus.PASS, "Share Certificate Popup Open Successfully");
	    	  
	      }
	      else
	      {
	    	  test.log(LogStatus.FAIL, "Share Certificate Popup does not Open Successfully");
	      }
...
//	      EntityLocator.ClickSelectTransaction1(driver).click();
	...
	public static void Managementpersonnel (WebDriver driver, ExtentTest test) throws InterruptedException
	{
	    ...
	    Thread.sleep(2000);
	    List<WebElement>entitytype = driver.findElements(By.xpath("//*[@id='griDDLActionMenu_listbox']/li"));
		selectOptionFromDropDown_bs(entitytype, "Management Personnel");
		...
		selectOptionFromDropDown_bs(entitytype, "Management Personnel");
		       ...
		       File dir = new File("C:\\Users\\mayurig\\Downloads");
			    ...
			    File[] allFilesNew = dir1.listFiles();						//Counting number of files in directory after download
			     ...
			     Thread.sleep(2000);
			       EntityLocator.ClickMgmtPersonalCloseBtn(driver).click();
	...
	public static void ClickCommitte (WebDriver driver, ExtentTest test) throws InterruptedException
	{
	    ...
	    Thread.sleep(2000);
	    List<WebElement>entitytype = driver.findElements(By.xpath("//*[@id='griDDLActionMenu_listbox']/li"));
		selectOptionFromDropDown_bs(entitytype, "Committees");
...
//	    }
	...
	public static void ClickCommitteeMatrix (WebDriver driver, ExtentTest test) throws InterruptedException
	{
	    ...
	    Thread.sleep(7000);
	    List<WebElement>entitytype = driver.findElements(By.xpath("//*[@id='griDDLActionMenu_listbox']/li"));
		selectOptionFromDropDown_bs(entitytype, "Committee Matrix");
...
//	    }
	...
	public static void AddStatutoryAuditor (WebDriver driver, ExtentTest test) throws InterruptedException
	{
		  ...
		  selectOptionFromDropDown_bs(LeaveType, "Auditors");
	       ...
	       Thread.sleep(2000);
	       EntityLocator.ClickDateOfAGM(driver).click();
	       List<WebElement> LeaveType1= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
			  selectOptionFromDropDown_bs(LeaveType1, "5");
	       
	       Thread.sleep(2000);
	    //   EntityLocator.ClickDateOfAppointment(driver).click();
	       
	       Thread.sleep(2000);
	    //   EntityLocator.DOA161(driver).click();    // Select Date
	      ...
	      // EntityLocator.ClickStatutoryNo(driver).click();
	       ...
	       Thread.sleep(2000);
	       Thread.sleep(2000);
	       EntityLocator.FromDate(driver).click();
	       List<WebElement> LeaveType2= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
			  selectOptionFromDropDown_bs(LeaveType2, "6");
	       
	       Thread.sleep(2000);
	       EntityLocator.ClickDueDate(driver).click();
	       LeaveType2= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
			  selectOptionFromDropDown_bs(LeaveType2, "23");
	       
	       Thread.sleep(2000);
	       Thread.sleep(2000);
	       EntityLocator.ClickFYStartDateDate(driver).click();
	       LeaveType2= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
			  selectOptionFromDropDown_bs(LeaveType2, "15");
	       
	       EntityLocator.ClickFYLastDateDate(driver).click();
	       Thread.sleep(2000);
	       LeaveType2= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
			  selectOptionFromDropDown_bs(LeaveType2, "20");
	       JavascriptExecutor js = (JavascriptExecutor)driver;
	...
	public static void EnterInvalidDataStatutoryAuditor (WebDriver driver, ExtentTest test) throws InterruptedException
	{
	    ...
	    List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
		  selectOptionFromDropDown_bs(LeaveType, "Auditors");
	       ...
	       Thread.sleep(2000);
	       EntityLocator.DOA16(driver).click();    // Select Date
	       Thread.sleep(2000);
...
//	       EntityLocator.ClickFYLastDateDate(driver).sendKeys("01/30/2023");
	...
	public static void ClearBtnStatutoryAuditor (WebDriver driver, ExtentTest test) throws InterruptedException
	{
	    ...
	    List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
		  selectOptionFromDropDown_bs(LeaveType, "Auditors");
	       ...
	       Thread.sleep(2000);
	       EntityLocator.SearchAuditors(driver).sendKeys("New Automation Test",Keys.ENTER);
	...
	public static void ResignationofAuditor (WebDriver driver, ExtentTest test) throws InterruptedException
	{
	    ...
	    Thread.sleep(2000);
	    EntityLocator.ClickDateOfSubmission(driver).click();
	    
	    Thread.sleep(2000);
	     EntityLocator.DOA16(driver).click();    // Select Date
	    
	    Thread.sleep(2000);
	    EntityLocator.ClickDated(driver).click();
	    ...
	    Thread.sleep(2000);
	    EntityLocator.ClickUploadDocument(driver).sendKeys("C:\\Users\\snehalp\\Desktop\\sample.pdf");
...
//	       EntityLocator.ClickStatutoryNo(driver).click();
	...
	public static void EnterInvalidDataResignationofAuditor (WebDriver driver, ExtentTest test) throws InterruptedException
	{
	   ...
	   // EntityLocator.SelectLeaveType1(driver).click();
	    ...
	    Thread.sleep(2000);
	    EntityLocator.ClickUploadDocument(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareHolding_BasicDetails.xlsx");
...
//	       EntityLocator.SelectInternalAuditorCategory(driver).click();
	       Thread.sleep(2000);
	       WebElement LeaveType1 = driver.findElement(By.xpath("//*[@id='ddlCriteria_listbox']/li[2]"));
	       LeaveType1.click();
	       Thread.sleep(2000);
	       ...
	       Thread.sleep(2000);
	       EntityLocator.ClickDateOfAppointmentIA(driver).click();
	...
	public static void CloseBtnInternalAuditoredit (WebDriver driver, ExtentTest test) throws InterruptedException
	{
		WebDriverWait wait=new WebDriverWait(driver,40);
		Thread.sleep(2000);
		EntityLocator.selectImg(driver).click();
	...
	public static void ClearBtnInternalAuditor (WebDriver driver, ExtentTest test) throws InterruptedException
	{
	    ...
	    List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
		  selectOptionFromDropDown_bs(LeaveType, "Auditors");
	       ...
	       Thread.sleep(2000);
	       EntityLocator.SearchAuditorsIn(driver).sendKeys("Automation Test",Keys.ENTER);
...
//	    EntityLocator.SelectInternalLeaveType(driver).click();
	    ...
	    List<WebElement>LeaveType1 = driver.findElements(By.xpath("//ul[@id='ddlLeaveType_listbox']//li"));
		  ...
		  Thread.sleep(2000);
		    ...
		    List<WebElement> LeaveType2= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
			  selectOptionFromDropDown_bs(LeaveType2, "5");
	       Thread.sleep(2000);
		    ...
		    List<WebElement> LeaveType3= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
			  selectOptionFromDropDown_bs(LeaveType3, "5");
	       Thread.sleep(2000);
	    Thread.sleep(2000);
	    EntityLocator.ClickReason(driver).sendKeys("Test");
	    
	    Thread.sleep(2000);
	    EntityLocator.ClickUploadDocument(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\dummy-pdf_2.pdf");
	...
	public static void EmptyFiledsCloseBtnResignationofInternalAuditor (WebDriver driver, ExtentTest test) throws InterruptedException
	{
		WebDriverWait wait=new WebDriverWait(driver,40);
		Thread.sleep(2000);
		EntityLocator.selectImg(driver).click();
	  	   ...
	  	   if(EntityLocator.CloseEntity(driver).isEnabled())
	  	    {
	  	    	 Thread.sleep(2000);
	  	  		EntityLocator.CloseEntity(driver).click();
	  	    	test.log(LogStatus.PASS, " The user is redirected to the previous page and no changes are made to the Resignation Auditor detail. ");
	  	    }
	  	    else
	  	    {
	  	    	test.log(LogStatus.FAIL, "resignation not cancel");
	...
	public static void SecretarialAuditor(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    EntityLocator.clickEntity(driver).click();
	    Thread.sleep(2000);
	    EntityLocator.ClickFilter(driver).sendKeys("U72266KA2002PLC038436",Keys.ENTER); //Deemmed Public company
...
//				EntityLocator.Certificate_of_Practice(driver).sendKeys(c1.getStringCellValue()); // Writing Task title
				...
				EntityLocator.Certificate_of_Practice(driver).sendKeys("" + No + ""); // Writing Task title
				Thread.sleep(4000);
				
				EntityLocator.NameofPracticingCompany(driver).sendKeys("NameofPracticingCompany"); // Writing Task title
				Thread.sleep(4000);
				...
				EntityLocator.Natureofappointment(driver).click();
				Thread.sleep(1000);	
				EntityLocator.Natureofappointment1(driver).click();
				Thread.sleep(3000);
				
				EntityLocator.TermofAuditor(driver).click();
				Thread.sleep(1000);	
				EntityLocator.TermofAuditor1(driver).click();
				Thread.sleep(3000);
				
				EntityLocator.AppointedforNoofYears(driver).click();
				Thread.sleep(1000);	
				EntityLocator.AppointedforNoofYears1(driver).click();
				Thread.sleep(3000);
				
				EntityLocator.AGNoTillAppointed(driver).sendKeys("2"); // Writing Task title
				Thread.sleep(4000);
				
				EntityLocator.FYstartDate(driver).click();
				Thread.sleep(1000);	
				 List<WebElement> LeaveType1= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
				  selectOptionFromDropDown_bs(LeaveType1, "5");
				  
				  EntityLocator.FYEndDate(driver).click();
					Thread.sleep(1000);	
					  LeaveType1= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
					  selectOptionFromDropDown_bs(LeaveType1, "7");
					  
					  EntityLocator.DateofAppointment(driver).click();
						Thread.sleep(1000);	
						  LeaveType1= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
						  selectOptionFromDropDown_bs(LeaveType1, "8");
					  
						  EntityLocator.AGMDueDatetillwhichAppointment(driver).click();
							Thread.sleep(1000);	
							  LeaveType1= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
							  selectOptionFromDropDown_bs(LeaveType1, "15");
							  
						//	  EntityLocator.CertificateNumber(driver).sendKeys("22"); // Writing Task title
								Thread.sleep(4000);
								Thread.sleep(3000);
								By locator = By.xpath("//*[@id='CertificateNumber']");
							...
							JavascriptExecutor jse=(JavascriptExecutor) driver;
							jse.executeScript("arguments[0].click();", ViewButton);
							ViewButton.sendKeys("22");
							
								Thread.sleep(4000);
									
									Thread.sleep(4000);
								 EntityLocator.DateofIssue(driver).click();
									Thread.sleep(1000);	
									  LeaveType1= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
									  selectOptionFromDropDown_bs(LeaveType1, "3");
									  
									  EntityLocator.CertificateValidUpto(driver).click();
										Thread.sleep(1000);	
										  LeaveType1= driver.findElements(By.xpath("//*[@role='gridcell']/a"));
										  selectOptionFromDropDown_bs(LeaveType1, "25");
...
//				 selectOptionFromDropDown_bs(LeaveType1, "LNTT Firm");
				Thread.sleep(3000);
		  ...
		  selectOptionFromDropDown_bs(LeaveType, "Auditors");
			...
			EntityLocator.SecretarialAuditor(driver).click();
				...
				if(EntityLocator.CloseSA(driver).isEnabled()) {
					...
					By locator = By.xpath("//*[@id='btnclose2']");
		  ...
		  selectOptionFromDropDown_bs(LeaveType, "Auditors");
			...
			EntityLocator.SecretarialAuditor(driver).click();
				Thread.sleep(3000);
				 ...
				 Thread.sleep(2000);
			       EntityLocator.SearchStatutory(driver).sendKeys("Individual",Keys.ENTER);
	    ...
	    List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
		  selectOptionFromDropDown_bs(LeaveType, "Auditors");
			...
			EntityLocator.Current(driver).click();
				...
				EntityLocator.ChooseFileRA(driver).sendKeys("C:\\Users\\snehalp\\Desktop\\sample.pdf"); // Writing Task title
				Thread.sleep(2000);
...
//				EntityLocator.Cancel(driver).click();
		  ...
		  selectOptionFromDropDown_bs(LeaveType, "Auditors");
			...
			EntityLocator.CostAuditor(driver).click();
				Thread.sleep(3000);
				 ...
				 Thread.sleep(2000);
			       EntityLocator.SearchStatutory(driver).sendKeys("Audit Firm",Keys.ENTER);
	     ...
	     List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
		  selectOptionFromDropDown_bs(LeaveType, "Auditors");
			...
			EntityLocator.CostAuditor(driver).click();
				...
				EntityLocator.ChooseFileRA(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\dummy-pdf_2.pdf"); // Writing Task title
				Thread.sleep(2000);
				EntityLocator.SaveRA(driver).click();
				Thread.sleep(3000);
	     ...
	     List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
		  selectOptionFromDropDown_bs(LeaveType, "Auditors");
			...
			EntityLocator.CostAuditor(driver).click();
				...
				EntityLocator.ChooseFileRA(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\ShareHolding_BasicDetails.xlsx"); // Writing Task title
				Thread.sleep(2000);
				EntityLocator.SaveRA(driver).click();
				Thread.sleep(3000);
	...
	public static void ClickMBP4(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    EntityLocator.ClickMoreAction(driver).click();
         ...
         Thread.sleep(2000);
	     List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
		  selectOptionFromDropDown_bs(LeaveType, "Statutory Registers");
	    ...
	    Thread.sleep(2000);
	     List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
		  selectOptionFromDropDown_bs(LeaveType, "Statutory Registers");
           ...
           Thread.sleep(2000);
           EntityLocator.SelectFile1(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\SampleExcelMBP4-Existing.xlsx");
           Thread.sleep(2000);
	...
	public static void ClickUploadExistingRegistorInvalidData(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    Thread.sleep(2000);
	     List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
          ...
          EntityLocator.clickUploadBtn(driver).click();
          Thread.sleep(2000);
          EntityLocator.SelectFile1(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\SampleExcelMBP4-Existing_Invalid.xlsx");
          Thread.sleep(2000);
          EntityLocator.clickUploadBtn1(driver).click();
	...
	public static void ClickUploadExistingRegistorDupliacteData(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    Thread.sleep(2000);
         ...
         EntityLocator.clickUploadBtn(driver).click();
         Thread.sleep(2000);
         EntityLocator.SelectFile1(driver).sendKeys("C:\\Users\\snehalp\\Documents\\SampleExcelMBP4-Existing.xlsx");
         Thread.sleep(2000);
         EntityLocator.clickUploadBtn1(driver).click();
	...
	public static void ClickUploadExistingRegistorWithoutData(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    Thread.sleep(2000);
         ...
         Thread.sleep(2000);
         EntityLocator.SelectFile1(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\SampleExcelMBP4-ExistingWD.xlsx");
	...
	public static void ClickUploadExistingRegistorInvalidFileFormat(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
        ...
        Thread.sleep(2000);
        EntityLocator.SelectFile1(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\EntityExcelFile2.xlsx");
	...
	public static void ClickUploadOldRegistorWithValidData(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
      ...
      Thread.sleep(2000);
      EntityLocator.SelectFile1(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\SampleExcelMBP4-Old.xlsx");
	...
	public static void ClickUploadOldRegistorWithInValidData(WebDriver driver, ExtentTest test) throws InterruptedException
     ...
     Thread.sleep(2000);
     EntityLocator.SelectFile1(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\SampleExcelMBP4-OldInvalid.xlsx");
	...
	public static void ClickUploadOldRegistorWithoutData(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
       ...
       Thread.sleep(2000);
       EntityLocator.SelectFile1(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\SampleExcelMBP4-OldWD.xlsx");
	...
	public static void ClickUploadOldRegistorInvalidFile(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
      ...
      Thread.sleep(2000);
      EntityLocator.SelectFile1(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\Scretrial.xlsx");
	...
	public static void clickPASTRODwithValidData(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    Thread.sleep(2000);
	     List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
	      ...
	      Thread.sleep(2000);
	      EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\SamplePastDirectorUpload.xlsx");
	      Thread.sleep(2000);
...
//	      }
	      ...
	      try 
		  {
		   Thread.sleep(100);
	      String msg=EntityLocator.clickPASTRODValidMsg(driver).getText();
	      test.log(LogStatus.PASS,"Enter Valid Data In PASTROD Excel File  =" +msg );
	    ...
	    catch(Exception  e) 
		  {
	  	 Thread.sleep(400);
			 String msg=EntityLocator.clickPASTRODInValidMsg(driver).getText();
			  test.log(LogStatus.FAIL, "Enter Valid Data In PASTROD Excel File  =" +msg );
	...
	public static void clickPASTRODwithInValidData(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    Thread.sleep(2000);
         ...
         Thread.sleep(2000);
	      ...
	      EntityLocator.clickPASTRODUpload(driver).click();
	      Thread.sleep(2000);
	      EntityLocator.clickChooseFile(driver).sendKeys("D:\\DotNetScretarial\\Secretarial-Project-26JULY23\\TestData\\SamplePastDirectorUpload_Invalid.xlsx");
	      Thread.sleep(2000);
	      EntityLocator.clickPASTRODUploadButton(driver).click();
	      //Thread.sleep(2000);
//	      String msg=EntityLocator.clickPASTRODValidMsg(driver).getText();
...
//	      
		  ...
		  {
	    	  Thread.sleep(100);
		      String msg=driver.findElement(By.xpath("//*[@id='frmUpdateUploadEntity']/div[1]/div/div/ul/li[1]/label")).getText();
		     // Thread.sleep(100);
		      String msg1=driver.findElement(By.xpath("//*[@id='frmUpdateUploadEntity']/div[1]/div/div/ul/li[2]/label")).getText();
		      //Thread.sleep(100);
		      String msg2=driver.findElement(By.xpath("//*[@id='frmUpdateUploadEntity']/div[1]/div/div/ul/li[3]/label")).getText();
		     // Thread.sleep(100);
		      String msg3=driver.findElement(By.xpath("//*[@id='frmUpdateUploadEntity']/div[1]/div/div/ul/li[4]/label")).getText();
	      
	      
		      test.log(LogStatus.PASS,"Enter InValid Data In PASTROD Excel File  =" +msg + "," +msg1 + ","+msg2 + "," +msg3);
	    ...
	    catch(Exception  e) 
		  {
	    	Thread.sleep(100);
			 String msg=EntityLocator.clickPASTRODValidMsg(driver).getText();
			  test.log(LogStatus.FAIL, "Enter InValid Data In PASTROD Excel File  =" +msg );
	...
	public static void clickPASTRODwithDuplicateData(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
        ...
        Thread.sleep(2000);
	      ...
	      test.log(LogStatus.PASS,"Enter duplicate Data In PASTROD Excel File  =" +msg );
	    ...
	    catch(Exception  e) 
		  {
	  	 Thread.sleep(400);
			 String msg=EntityLocator.clickPASTRODValidMsg(driver).getText();
			  test.log(LogStatus.FAIL, "Enter duplicate Data In PASTROD Excel File  =" +msg );
	...
	public static void clickPASTRODwithoutData(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
       ...
       Thread.sleep(2000);
	      ...
	      EntityLocator.clickPASTRODUpload(driver).click();
	      Thread.sleep(2000);
	      EntityLocator.clickChooseFile(driver).sendKeys("D:\\Secretarial-Project-26JULY23\\Secretarial-Project\\SamplePastDirectorUpload WithoutData.xlsx");
	      Thread.sleep(2000);
	      EntityLocator.clickPASTRODUploadButton(driver).click();
	      try 
		  {
	      ...
	      test.log(LogStatus.PASS,"Enter without Data In PASTROD Excel File  =" +msg );
	    ...
	    catch(Exception  e) 
		  {
	  	 Thread.sleep(400);
			 String msg=EntityLocator.clickPASTRODInValidMsg(driver).getText();
			  test.log(LogStatus.FAIL, "Enter without Data In PASTROD Excel File  =" +msg );
	...
	public static void clickPASTRODInvalidFile(WebDriver driver, ExtentTest test) throws InterruptedException
	 {
	    ...
	    Thread.sleep(2000);
	     List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
	      ...
	      test.log(LogStatus.PASS,"Uploaod Invalid File  =" +msg );
	    ...
	    catch(Exception  e) 
		  {
	  	 Thread.sleep(400);
			 String msg=EntityLocator.clickPASTRODInValidMsg(driver).getText();
			  test.log(LogStatus.FAIL, "Uploaod Invalid File   =" +msg );
	     ...
	     List<WebElement> LeaveType= driver.findElements(By.xpath("//ul[@id='griDDLActionMenu_listbox']//li"));
	      ...
	      File dir = new File("C:\\Users\\mayurig\\Downloads");
		    ...
		    File[] allFilesNew = dir1.listFiles();						//Counting number of files in directory after download
		  	...
		  	if (dirContents.length < allFilesNew.length) 
		  	{
		  		test.log(LogStatus.PASS,  "Register of Past Director should be download successfully");
		  	} 
		  	else 
		  	{
		  		test.log(LogStatus.FAIL, "Register of Past Director should not be download successfully");
		  	}
		    Thread.sleep(2000);
	   		EntityLocator.ClickDashboard(driver).click();
